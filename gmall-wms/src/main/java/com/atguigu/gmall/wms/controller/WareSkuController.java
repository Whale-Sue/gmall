...
public class WareSkuController {
     ...
     * @return
     */
    @PostMapping(value = "/check/lock/{orderToken}")
    public ResponseVo<List<SkuLockVo>> checkAndLock(@RequestBody List<SkuLockVo> skuLockVoList, @PathVariable("orderToken") String orderToken) {
        List<SkuLockVo> skuLockVos= this.wareSkuService.checkAndLock(skuLockVoList, orderToken);
    ...
    public ResponseVo<List<WareSkuEntity>> queryWareSkusBySkuId(
        ...
        List<WareSkuEntity> wareSkuEntities =
                this.wareSkuService.list(new QueryWrapper<WareSkuEntity>().eq("sku_id", skuId));
