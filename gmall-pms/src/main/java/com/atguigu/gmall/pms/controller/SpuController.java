...
public class SpuController {
    ...
    /**
     * 为向ES中导入数据提供。返回值是当前页的spuEntity集合
     * @param pageParamVo
     * @return
     */
    ...
    public ResponseVo<PageResultVo> querySpuByCategoryIdAndPage(
            @PathVariable(value = "categoryId")Long categoryId, PageParamVo pageParamVo) {
        PageResultVo pageResultVo = this.spuService.querySpuByCategoryIdAndPage(categoryId, pageParamVo);
